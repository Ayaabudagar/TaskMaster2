...
public class PushListenerService extends FirebaseMessagingService {
    ...
    public void onNewToken(@NonNull @NotNull String s) {
        HomePage.getPinpointManager(getApplicationContext()).getNotificationClient().registerDeviceToken(s);
    }
    @Override
    public void onMessageReceived(@NonNull @NotNull RemoteMessage remoteMessage){
        super.onMessageReceived(remoteMessage);
        Log.i("msg received","this is a test");
      final   NotificationClient notificationClient= HomePage.getPinpointManager(getApplicationContext()).getNotificationClient();
